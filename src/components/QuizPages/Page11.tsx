...
export const Page11 = ({ nextPage }: Props) => {
  const { setAreYouArtistType } = useFormStore();
  ...
  return (
    ...
    >
      ...
      >
        {t("Posiadam artystyczne lub twórcze zainteresowania.")}
      </motion.h2>
