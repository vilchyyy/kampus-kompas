...
export const Page15 = ({ nextPage }: Props) => {
  const { setEcologyType } = useFormStore();
  ...
  return (
    ...
    >
      ...
      >
        {t("Jestem zainteresowany zagadnieniami związanymi z ochroną środowiska lub zrównoważonym rozwojem.")}
      </motion.h2>
