...
export const Page12 = ({ nextPage }: Props) => {
  const { setSociallyInterestedType } = useFormStore();
  ...
  return (
    ...
    >
      ...
      >
        {t("Interesuję się kwestiami społecznymi, takimi jak: edukacja, zdrowie publiczne lub pomoc społeczna.")}
      </motion.h2>
