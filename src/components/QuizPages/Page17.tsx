...
export const Page17 = ({ nextPage }: Props) => {
  ...
  return (
    ...
    >
      ...
      >
        {t("Jestem zainteresowany matematyką, technologią, zarządzeniem danymi.")}
      </motion.h2>
