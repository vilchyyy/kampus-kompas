...
export const Page16 = ({ nextPage }: Props) => {
  ...
  return (
    ...
    >
      ...
      >
        {t("Interesuję się edycją filmów, obróbką zdjęć lub też innego rodzaju sztuką.")}
      </motion.h2>
